...
int s21::S21Matrix::GetRows() const { return rows_; }

int s21::S21Matrix::GetCols() const { return cols_; }
...
s21::S21Matrix s21::S21Matrix::CopyMatrix(const S21Matrix &other, int rows,
                                          int cols) {
